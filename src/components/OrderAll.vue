    ...
    <div class="relative">
      <div class="tab">
        <div class="order-query-allover clearfix">
          ...
          <el-button type="primary" class="order-query-ico" icon="el-icon-search" @click="queryOrder">查询</el-button>
      ...
      <div class="footer" v-if="showFooter">
        <el-pagination
          background
          @current-change="getOrderCurrentData"
